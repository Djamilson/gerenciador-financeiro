import { LancamentoTotal } from './../../core/model';
...
export class DashboardComponent implements OnInit {
  ...
  dataHoje = new Date();
  condition = false;
  lancamentoTotal = new LancamentoTotal();
  ...
  pesquisar() {
      ...
      this.dashboardService.totalReceitasMenosDespesasMes ()
      .then(resultado => {
        console.log('Total::: ', resultado);
        this.lancamentoTotal = resultado;
        // para mudar a cor da div total
        if (this.lancamentoTotal.totalReceitasDespesasMes > 0) {
           this.condition = true;
        }
      })
