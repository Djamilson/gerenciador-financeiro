...
import { PessoaFiltro, PessoaService } from '../../shared/services/pessoa.service';
...
export class PessoasPesquisaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.cols = [
      ...
      { field: 'cidade', header: 'Cidade', class: 'col-data-header'},
      { field: 'estado', header: 'Estado', class: 'col-data-header' },
